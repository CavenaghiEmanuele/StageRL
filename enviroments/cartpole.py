...
class QEstimator():
    ...
    def __init__(self, step_size, env, num_tilings=16, max_size=4096, tiling_dim=None, trace=False):
        ...
        # if params is +-inf subtraction is not necessary
        self.cart_position = self.tiling_dim / (env.observation_space.high[0] \
                                                  - env.observation_space.low[0])
        self.cart_velocity = self.tiling_dim / (env.observation_space.high[1])
        self.pole_angle = self.tiling_dim / (env.observation_space.high[2] \
                                                  - env.observation_space.low[2])
        self.pole_velocity = self.tiling_dim / (env.observation_space.high[3])
